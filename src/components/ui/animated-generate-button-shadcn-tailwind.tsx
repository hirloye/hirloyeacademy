    ...
    <div className={clsx("relative inline-block", className)} id={id}>
      ...
      >
        ...
        <div className="ui-anim-txt-wrapper relative flex min-w-[6.4em] items-center justify-center">
          <div className="ui-anim-txt-1 absolute flex animate-[ui-appear_1s_ease-in-out_forwards]">
            {Array.from(labelIdle).map((ch, i) => (
              <span key={i} className={`ui-anim-letter inline-block ${ch === ' ' ? 'w-1' : ''}`}>
                {ch}
              </span>
            ))}
          </div>
      ...
      <style jsx>{`
        ...
        /* Focus swaps removed as per request */
        ...
        .ui-anim-txt-1 .ui-anim-letter:nth-child(6) { animation-delay: 0.4s; }
        ...
        .ui-anim-txt-1 .ui-anim-letter:nth-child(11) { animation-delay: 0.8s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(12) { animation-delay: 0.88s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(13) { animation-delay: 0.96s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(14) { animation-delay: 1.04s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(15) { animation-delay: 1.12s; }
